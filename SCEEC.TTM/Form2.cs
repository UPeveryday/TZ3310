...
namespace SCEEC.TTM
{
    public partial class Form2 : Form
    {
        ...
        public Form2(short[] Tdata, string oltclable)
        {
            InitializeComponent();
            OLTCLABEL = oltclable;
            HideLabel(oltclable);
        ...
        private void Button2_Click_1(object sender, EventArgs e)
        {
            ...
            panel11.Visible = false;
            panel12.Visible = false;
            //savechart(chart1, OLTCLABEL + "A");
            //savechart(chart2, OLTCLABEL + "B");
            //savechart(chart3, OLTCLABEL + "C");
            // saveimages();
            //this.Close();
        }
        /// <summary>
        ...
        private void Button3_Click(object sender, EventArgs e)
        {
            ...
            InsertDataTodatabase.CreateWaveResult(or,11);
            this.Close();
