...
namespace SCEEC.MI.TZ3310
{
    public static class GetParameter
    {
        ...
        public static Parameter.JYDZVoilt GetPraBushingDCInsulationVoltage(JobList job)
        {

            int DCInsulationVoltage = job.Parameter.BushingDCInsulationVoltage / 100;
            switch (DCInsulationVoltage)
            {
                case 2: return Parameter.JYDZVoilt._0_25KV;
                case 5: return Parameter.JYDZVoilt._0_5KV;
        ...
        public static Parameter.JSVoilt GetPraBushingCapacitanceVoltage(JobList job)
        {
            int CapacitanceVoltage = job.Parameter.BushingCapacitanceVoltage / 100;
            switch (CapacitanceVoltage)
            {
                case 5: return Parameter.JSVoilt._0_5KV;
                case 6: return Parameter.JSVoilt._0_6KV;
        ...
        public static Parameter.ZldzCurrent GetPraDCResistanceUpanCurrent(JobList job)
        {
            int DCResistanceCurrent = job.Parameter.DCResistanceCurrent;

            switch (DCResistanceCurrent)
            {
                case 5: return Parameter.ZldzCurrent._1A;
                case 10: return Parameter.ZldzCurrent._3A;
        ...
        public static Parameter.YzfjCurrent GetPraDCResistanceCurrentOLTCSpa(MeasurementItemStruct mi, JobList job)
        {
            int DCResistanceCurrent = job.Parameter.DCResistanceCurrent;

            if (mi.WindingConfig == TransformerWindingConfigName.Yn)
            {
                if (DCResistanceCurrent == 10)
                    return Parameter.YzfjCurrent._3_A;
                else if (DCResistanceCurrent == 1)
            ...
            else
            {
                switch (DCResistanceCurrent)
                {
                    case 1: return Parameter.YzfjCurrent._1_A;
                    case 3: return Parameter.YzfjCurrent._3_A;
                    case 10: return Parameter.YzfjCurrent._10_A;
