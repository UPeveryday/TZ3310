...
namespace SCEEC.MI.TZ3310
{
    public static class UpanForWriteToFile
    {
        ...
        /// <param name="job"></param>-------------
        public static void writefile(string basepath, string ListlisName, JobList job, List<MeasurementItemStruct> miList, string JobNameTextBox)
        {
           // CheckFile();
            ...
            string TaskPath = basepath + JobNameTextBox.Trim();
