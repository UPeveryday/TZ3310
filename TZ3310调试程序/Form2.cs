...
namespace TZ3310调试程序
{
    public partial class Form2 : Form
    {
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            ...
            panel1.Parent = chart1;
            panel2.Parent = chart1;
            panel3.Parent = chart2;
            panel4.Parent = chart2;
            panel5.Parent = chart3;
            panel6.Parent = chart3;
            panel1.BackColor = Color.FromArgb(150, 255, 0, 0);
            panel2.BackColor = Color.FromArgb(150, 255, 0, 0);
            panel3.BackColor = Color.FromArgb(150, 255, 0, 0);
            panel4.BackColor = Color.FromArgb(150, 255, 0, 0);
            panel5.BackColor = Color.FromArgb(150, 255, 0, 0);
            panel6.BackColor = Color.FromArgb(150, 255, 0, 0);
        }
